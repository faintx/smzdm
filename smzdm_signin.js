...
; (async () => {
  ...
  let content = '';
  // 获取Cookie
  let smzdmCookie = '__ckguid=Ygv25xuaN7XaPS2iYtLpob; __jsluid_s=0c19737bc405305e85039fdcb6d4b4d8; r_sort_type=score; zdm_qd=%7B%22referrer%22%3A%22https%3A%2F%2Fcn.bing.com%2F%22%7D; _gid=GA1.2.1761461271.1624370065; device_id=308391797516243700525414164a12fd1ce7988f84ad4422732473cedc; sess=ZWMzMTl8MTYyOTU1NDA1MnwzNjAyNDEzODUyfDNmOGNlOWY3M2RlMmUyYjRhNDEyZWRhM2M0MjdjY2JjfDMwODM5MTc5NzUxNjI0MzcwMDUyNTQxNDE2NGExMmZkMWNlNzk4OGY4NGFkNDQyMjczMjQ3M2NlZGN8d2Vi; user=user%3A3602413852%7C3602413852; smzdm_id=3602413852; homepage_sug=f; smzdm_user_view=13CBE57CDAF3501EFE348C74CD6D954A; smzdm_user_source=234630454B62CF063618B6E58560926C; _zdmA.uid=ZDMA.rympE_33v.1624542575.2419200; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%223602413852%22%2C%22first_id%22%3A%22179934c46b9af6-0d1e854b784645-7e697a60-2073600-179934c46ba88%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%9B%B4%E6%8E%A5%E6%B5%81%E9%87%8F%22%2C%22%24latest_search_keyword%22%3A%22%E6%9C%AA%E5%8F%96%E5%88%B0%E5%80%BC_%E7%9B%B4%E6%8E%A5%E6%89%93%E5%BC%80%22%2C%22%24latest_referrer%22%3A%22%22%2C%22%24latest_landing_page%22%3A%22https%3A%2F%2Fwww.smzdm.com%2F%22%7D%2C%22%24device_id%22%3A%22179934c46b9af6-0d1e854b784645-7e697a60-2073600-179934c46ba88%22%7D; Hm_lvt_9b7ac3d38f30fe89ff0b8a0546904e58=1623653822,1624370064,1624457149,1624542577; Hm_lpvt_9b7ac3d38f30fe89ff0b8a0546904e58=1624542577; _ga_09SRZM2FDD=GS1.1.1624542582.5.0.1624542582.0; _ga=GA1.2.740207815.1621673926';
  try {
    // 查询签到前用户数据
    ...
    if (!nickName) {
      ...
      sendMsg(scriptName, 'Cookie过期已过期，请重新登录!')
      magicJS.done();
    }
    else {
      ...
      if (webCheckinErr) {
        ...
        magicJS.notify(title, subTitle, content);
        magicJS.notify(avatar)
...
function getPushBody(title, content) {
  console.log(content)
...
function sendMsg(title, content) {
  // console.log(process.env.CORPID)
  ...
  magicJS.get(accesTokenOption, (err, resp, data) => {
    try {
      ...
      push(JSON.parse(data).access_token, getPushBody(title, content))
    } catch (err) {
...
function push(access_token, b) {
  ...
  magicJS.post(pushOption, (err, resp, data) => {
    console.log('121212' + resp.statusCode)
    if (JSON.parse(data).errcode == 0) {
      magicJS.notify('发送消息成功！')
    }
  })
}
